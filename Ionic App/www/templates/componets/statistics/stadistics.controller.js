/* globals baymaxPiApp */
baymaxPiApp.controller('StadisticsCtrl', function ($scope, $http, $timeout, $ionicHistory) {
  $scope.data;
  $scope.dataEcg;
  $scope.dataEmg;
  ...
  $scope.doRefresh = function () {
    ...
    var URL_Alertas = 'http://192.168.0.8:4000/m2m/applications/Central/containers/alarmContainer/contentInstances/';
    var URL_Todo = 'http://192.168.0.8:4000/m2m/applications/TempSensor1/containers/presContainer/contentInstances/';
    var URL_EMG = 'http://192.168.0.8:4000/m2m/applications/TempSensor1/containers/emgContainer/contentInstances/';
    var URL_ECG = 'http://192.168.0.8:4000/m2m/applications/TempSensor1/containers/ecgContainer/contentInstances/'
