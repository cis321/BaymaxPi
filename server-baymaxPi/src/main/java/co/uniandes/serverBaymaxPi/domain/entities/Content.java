...
import co.uniandes.serverBaymaxPi.api.representations.ContentFooterDTO;
import co.uniandes.serverBaymaxPi.api.representations.ContentGeneric;
...
public class Content {
    ...
    @JsonCreator
    public Content(@JsonProperty("_id") String _id, @JsonProperty("helpContentUser") String helpContentUser,
